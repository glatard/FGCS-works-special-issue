...
Environment~\cite{dinov2009efficient} and in the Catania Science
Gateway Framework~\cite{Ardizzone2012} which is used for instance in
the DECIDE gateway instance for
neuroimaging~\cite{ardizzone2012decide} (see specific documentation on
workflows\footnote{\url{http://bit.ly/1oQrzvQ}}). \todo{Add
  description of a real system.\note{Tristan}{The Catania Science
    Gateway Framework would be a good illustration here (workflow
    engine is a Java portlet), but I can't find a suitable figure
    about it.}}
