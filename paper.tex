...
access distributed infrastructures, usually through a web interface.
Tools usually help users manage data transfers, task execution and
authentication on multiple computing and storage locations. Workflow
engines are of course part of this ecosystem since they are useful
systems to implement and execute applications. 

Several models 

Examples: CBRAIN, VIP, NSG, etc
