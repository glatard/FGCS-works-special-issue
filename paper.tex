...
analyses to avoid re-computation, and so on. A wide array of workflows
have been implemented using these pipelines and are now shared across
...
%Some gateways may not even use any
...
Specific features may also be available, for instance
