...
(\texttt{O$_1$}=1).  
\note{sil}{why not? if the engine is ws-pgrade it can. i really think that meta-workflows is a property exclusively of the engine. you can see that in fig 2.V interaction *6}
