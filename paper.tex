...
\title{Software Architectures for Integrating Workflow Engines in Science Gateways} \note{Naj}{'what' software architectures? what is their qualifier, adjective?}
...
\begin{abstract}
  ...
  workflow engines in science gateways. We describe and evaluate these software
  architectures with metrics that measure integration complexity,
  robustness, extensibility, scalability and other specific
  features\note{Naj}{Please be precise, what are they?}. Results illustrate the pros and cons of different
  architectures: Simple architectures with tight integration and task encapsulation are the
  the easiest to integrate and are most robust.Extensibility is equivalent in most architectures. The pool model is the most scalable one and meta-workflows are only available in nested workflows and workflow
  import. Our analysis provides insights for science gateway
  architects and workflow engine developers. \note{Naj}{I find this abstract to be vague, it can be made more concise and poignant}
\end{abstract}
...
exploitation of distributed infrastructures in the ecosystem of tools and
services offered by science gateways . Several
software architectures can be adopted to integrate workflow engines in
science gateways, however 
development effort required and the resulting system vary across different architectures. This paper and our analytical approach to comparison of software architectures is informed by our experince in the development and
sustained operation of the CBRAIN~\cite{SHER-14} and
VIP~\cite{GLAT-13} science gateways for medical image analysis during
the past 7 years; as well as by lessons learned from several
science gateway and workflow projects, including
SHIWA\footnote{\url{http://www.shiwa-workflow.eu}} and related
initiatives. This paper describes,
provides examples and compares such architectures, based on
system-independent representations of their main components and
interactions. In this section we provide background information and
definitions of different workflow engines, science gateways and
infrastructures. In Section~\ref{sec:architectures}, we describe six
architectures within a consistent framework that underlines the functional
interactions between their main software components. In
Section~\ref{sec:evaluation}, different architectures are evaluated with
metrics measuring integration challenge, robustness, extensibility,
scalability and other specific features. We compare different architectures and highlight
...
advanced features such as provenance tracking (Nipype, PSOM), \note{Naj}{should we not mention PMP which is used for CIVET?}
...
In this paper, the working definition of a
...
components and interactions. \note{Naj}{three 'interactions' in one sentence} They are represented with dotted arrows
...
Red color (WHERE?) is used to represent the components and interactions that
...
engine. \note{Naj} {this reads funny} The parent and child engines might use different workflow
...
difficulty to extend the architecture. \note{Naj}{I would rather compare each metric separately, this woudl also give a sense of how different architectures compare across metrics} Note that some extensions may
...
implemented with a nonsensical amount of effort\note{Naj}{how do you metricize "nonesensical amount fo effors?"}. Four different
...
\item Task scheduling (\texttt{S$_3$}): task scheduling is a difficult
  ...
  scheduling problem by introducing additional software layers, or by
...
Robustness (normalized total) &
                                \cellcolor[HTML]{99F099}{0.14}
                                    ...
                                    & \cellcolor[HTML]{999999}{1.00}
                                    & \cellcolor[HTML]{99D399}{0.43}\\
  Extensibility (normalized total)  & \cellcolor[HTML]{99D299}{0.44}
                                     & \cellcolor[HTML]{99D299}{0.44}
                                     & \cellcolor[HTML]{99FF99}{0.00}
                                     & \cellcolor[HTML]{99E899}{0.22}
                                     & \cellcolor[HTML]{999999}{1.00}
