...
\note{sil}{should we then also thank SURF foundation (for the dutchgrid), FP7 (for SCI_BUS, SHIWA and ER-flow), and COMMIT/ and HUvA HPCN for the funding for the amc science gateway activities. My participation has been minimal, and the amc gateways are not discussed in detail (my fault), so maybe it would be an overkill}
