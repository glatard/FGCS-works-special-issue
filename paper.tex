...
invocation) are the only architectures that support
meta-workflows. Besides, task encapsulation and nested workflows may
complexify fine-grained debugging. \closednote{Rafael}{I would suggest
  to provide some more examples when this could be
  interesting.}{Tristan}{Done.}  The availability of fine-grained
debugging information may also be critical to efficient user support.
