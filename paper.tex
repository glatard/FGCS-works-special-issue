...
\begin{abstract}
  ...
  to software architects on how to integrate science gateways and
  workflow engines.
\end{abstract}
...
pipelines and are now widely shared across neuroimaging groups
world-wide. These
...
domain-specific ones, may leave it to external processes. Workflows
...
provide performance through facilitated access to storage and
computing power. They are usually accessible through a web interface
...
servers. By September 2015, CBRAIN has served over 370 users across 50
...
Software interactions among these components are represented with plain black
