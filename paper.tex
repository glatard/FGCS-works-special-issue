...
task encapsulation and nested workflows may hamper
...
are not identified.
\note{vladimir}{@silvia, does it make sense to mention workflow classification efforts based on workflow motifs and so on?}
