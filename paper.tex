...
\note{Sil}{i changed above a few occurrences of "diagrammed". i know it is correct, but i am not used to seeing it. this is a matter of style, just forget my changes below then}
...
labeled (a,b,c, ...) as in Figure~\ref{fig:architectures}.
...
\item Workflow conversion: translation from one workflow language into
  another. This interaction may not be available or possible
  for every workflow language. It has been developed mostly for
  translation between well-structured and relatively simple workflow languages such as GWorkflowDL
  and Scufl~\cite{OLAB-09}, and the 4 languages that were involved in the
  SHIWA initiative.
 \note{Silvia}{Should we add here the 4?
 	and for translation among the 5 workflow systems in the SHIWA project: Askalon, MOTEUR, Taverna, Triana and WS-PGRADE)} 
\end{enumerate}
...
user.
\note{Sil}{about c1: should it also show from engine to infra in the figure? this is what i understand from the above sentence}
...
\note{Sil}{is this next sentence relevant?}In practice, both
