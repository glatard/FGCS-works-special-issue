...
\newcommand{\note}[1]{\color{ao(english)}\textbf{Note: }\textit{#1} \color{black}}
...
\item Data control: operations to manage data on the infrastructure,
  ...
  heterogeneous interfaces. \note{this -c2- can be also trigerred by the 
  user} Tools and services such as JSAGA~\cite{reynaud2010uniform} or
  Data Avenue~\cite{hajnal2014data} can be used to homogeneize these 
  interfaces.
